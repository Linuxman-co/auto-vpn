...
sudo apt install openvpn openssl mailutils zip gzip apache2 -y -q
...
read -pe "\e[1m\e[32mFor the VPN to work, we need to reboot the VPN. Press Enter to Continue...\e[39m\e[0m"
sudo reboot
